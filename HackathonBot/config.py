...
configs = [
    {
        ...
        # 任务名称，起标识作用
        'issue_name': "【快乐开源】Paddle Tensor 规范化",

        # 开始时间，只会统计开始时间之后的PR(注意时间中的字母T和Z不能缺少)
        'start_time' : '2024-11-05T00:00:00Z',

        # issue页面 url 地址, 注意结尾不要有斜杠
        'issue_url': 'https://api.github.com/repos/PaddlePaddle/Paddle/issues/69082',
        ...
        # 赛道名
        'type_names' : ["Paddle Tensor 规范化"],

        # 每个赛题所属的赛道，每个赛道是一个数组
        'task_types' : [['1-29']],

        # 该issue相关PR的前缀，用来标识PR是否属于该issue
        'pr_prefix' : "Paddle Tensor No.",
