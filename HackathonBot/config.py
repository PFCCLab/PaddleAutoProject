...
configs = [
    {
        ...
        # 任务名称，起标识作用
        'issue_name': "【快乐开源】PaddlePaddle 文档链接修复任务 -- 第一期 ",
        ...
        # 赛道名
        'type_names' : ["【快乐开源】PaddlePaddle 文档链接修复任务 -- 第一期"],
        ...
        # 任务名称，起标识作用
        'issue_name': "【快乐开源】PaddlePaddle 文档链接修复任务 -- 第二期 ",

        # 开始时间，只会统计开始时间之后的PR(注意时间中的字母T和Z不能缺少)
        'start_time' : '2026-01-26T00:00:00Z',

        # issue页面 url 地址, 注意结尾不要有斜杠
        'issue_url': 'https://api.github.com/repos/PaddlePaddle/docs/issues/7736',
        ...
        # 赛道名
        'type_names' : ["【快乐开源】PaddlePaddle 文档链接修复任务 -- 第二期"],
