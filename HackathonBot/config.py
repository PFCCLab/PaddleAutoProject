...
configs = [
    {
        ...
        # 任务名称，起标识作用
        'issue_name': "[Docathon]docs 代码风格检查工具对齐 Paddle",

        # 开始时间，只会统计开始时间之后的PR(注意时间中的字母T和Z不能缺少)
        'start_time' : '2023-10-24T00:28:48Z',

        # issue页面 url 地址, 注意结尾不要有斜杠
        'issue_url': 'https://api.github.com/repos/PaddlePaddle/docs/issues/6242',
